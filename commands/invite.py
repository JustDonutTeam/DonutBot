...
class Invite(commands.Cog):
    ...
    async def invite(self, ctx):
        embed = discord.Embed(
            ...
            description=f"You can invite me [[here]](https://discord.com/api/oauth2/authorize?client_id=738788356506386462&permissions=8&scope=bot). Remaining places: **{100-len(self.client.guilds)}**",
